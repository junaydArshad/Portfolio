...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'Email',
      url: 'mailto:junaidarshad439@gmail.com',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/junayd-arshad/',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/junaydArshad',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    <section id="contact" className="contact">
      <div className="container">
        ...
        <div className="contact-grid">
          ...
          >
            <h3 className="social-title glow-text">Let's Connect</h3>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="contact-form">
              ...
              <button
                type="submit"
                className="btn btn-primary form-submit glow-text"
