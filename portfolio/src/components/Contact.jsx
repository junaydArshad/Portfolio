...
const Contact = React.forwardRef((props, ref) => (
    <div ref={ref} className="h-screen bg-black flex items-center justify-center">
         <span className=" w-96 h-96 bg-red-500 rounded-full  blur-300"></span>
        ...
        <div class="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl font-[sans-serif]">
                    ...
                    <ul class="mt-4">
                        <li class="flex items-center">
                            ...
                            <a href="javascript:void(0)" class="text-white text-sm ml-4">
                                ...
                                <strong>junaidarshad439@gmail.com</strong>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <form class="ml-auto space-y-4">
                <input type='text' placeholder='Name'
                    class="w-full rounded-md py-3 px-4 bg-gray-100 text-gray-800 text-sm outline-teal-500 focus:bg-gray-100" />
        ...
        <span className="w-96 h-96 bg-teal-500 rounded-full blur-300"></span>
    </div>
));
